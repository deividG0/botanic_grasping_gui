...
class ImageRGBYOLO(Node):
    ...
    def generate_grasp(
        ...
        """
            This function return the grasp position [x, y, z, angle] based on
            the object mask returned by a YOLO model and depth image.
            OBS.: The possibility of merged masks is not being considered
            and might be a problem.
            But it can be solved with the bounding boxes also returned by
            the YOLO model.
        """
        m = mask
